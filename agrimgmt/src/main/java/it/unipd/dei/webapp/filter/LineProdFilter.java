...
/**
 * Check if the employee is an line production worker or an administrator and let that the employee uses the resocurces
 */
public class LineProdFilter implements Filter {
    ...
    public void doFilter(final ServletRequest servletRequest, final ServletResponse servletResponse, final FilterChain chain) throws IOException, ServletException {
        ...
        if (session != null) {
            ...
            } else if(employee.getRole().equals("Production line worker")||employee.getRole().equals("Administrator")){
