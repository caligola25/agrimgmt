...
/**
 * Check if the employee is an Designer or an Administrator and let that the employee uses the resocurces
 */
public class DesignerFilter implements Filter {
    ...
    public void doFilter(final ServletRequest servletRequest, final ServletResponse servletResponse, final FilterChain chain) throws IOException, ServletException {
        ...
        if (session != null) {
            ...
            } else if(employee.getRole().equals("Designer")||employee.getRole().equals("Administrator")){
