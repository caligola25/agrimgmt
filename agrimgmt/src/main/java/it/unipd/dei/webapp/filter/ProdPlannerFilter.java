...
/**
 * Check if the employee is an production planner or an administrator and let that the employee uses the resocurces
 */
public class ProdPlannerFilter implements Filter {
    ...
    public void doFilter(final ServletRequest servletRequest, final ServletResponse servletResponse, final FilterChain chain) throws IOException, ServletException {
        ...
        if (session != null) {
            ...
            } else if(employee.getRole().equals("Production planner")||employee.getRole().equals("Administrator")){
