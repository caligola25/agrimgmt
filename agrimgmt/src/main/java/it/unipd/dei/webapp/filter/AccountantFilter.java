...
/**
 * Check if the employee is an accountant or an administrator and let that the employee uses the resocurces
 */
public class AccountantFilter implements Filter {
    ...
    public void doFilter(final ServletRequest servletRequest, final ServletResponse servletResponse, final FilterChain chain) throws IOException, ServletException {
        ...
        if (session != null) {
            ...
            } else if(employee.getRole().equals("Accountant")||employee.getRole().equals("Administrator")){
