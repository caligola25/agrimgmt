...
<head>
<meta charset="UTF-8">
<title>Production orders management page</title>
...
<div>
    <div class="row">
        <span class="button-menu"><a href="<c:url value="/protected/jsp/prod_planner/insert-new-prod-order.jsp"/>"><button><p><i class="fas fa-plus fa-3x"></i></p><p>Add Production Order</p></button></a></span>
        <span class="button-menu"><a href="<c:url value="/protected/prod_planner/prod-order-list"/>"><button><p><i class="far fa-list-alt fa-3x"></i></p><p>Production Orders List</p></button></a></span>
