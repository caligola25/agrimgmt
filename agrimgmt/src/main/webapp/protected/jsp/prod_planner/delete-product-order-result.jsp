...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>Delete Product Order Result</title>
    ...
    <c:choose>
        ...
        <c:otherwise>
            <h1>Delete Product Order Result</h1>
    ...
    <a href="<c:url value="/protected/prod_planner/prod-order-list"/>"><button>Back to Product Order List</button></a><br>
