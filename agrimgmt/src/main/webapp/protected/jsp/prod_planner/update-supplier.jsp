...
<html lang="en">
    ...
    <body>
        ...
        <form method="POST" action="<c:url value="/protected/prod_planner/update-supplier"/>">
            <label for="oldName">Name of the Supplier to be modified:</label>
            <input name="oldName" id="oldName" type="text" value="${supName}"><br/>
            <label for="oldCountry">Name of the Supplier to be modified:</label>
            <input name="oldCountry" id="oldCountry" type="text" value="${supCountry}"><br/>
            ...
            <label for="country" class="radio_label">Country</label>
        ...
        <a href="<c:url value="/protected/prod_planner/supplier-list"/>"><button>Back</button></a><br>
